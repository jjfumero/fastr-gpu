...
public abstract class SequenceOfRepetitions extends RExternalBuiltinNode.Arg3 {
    ...
    protected RAbstractVector buildSequenceOfRepetitions(Object startObject, Object maxObject, Object repetitionsObject) {
        ...
        RIntSequence sequence = RDataFactory.createIntSequenceOfRepetitions(start, 1, max * repetitions, repetitions);
        return sequence;
    }
}
