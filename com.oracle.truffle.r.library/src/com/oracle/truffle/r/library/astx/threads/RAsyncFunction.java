...
public abstract class RAsyncFunction extends RExternalBuiltinNode.Arg2 {

    @Specialization
    public int createThreadAndRun(RFunction function, RAbstractIntVector input) {
        ...
        int idxThread = RThreadManager.INSTANCE.addThread(thread);
